...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
    ...
    final List<String> followQueryParams;
    ...
    OkHttpClient(Builder builder) {
        ...
        this.followQueryParams = Util.immutableList(builder.followQueryParams);
    ...
    public static final class Builder {
        ...
        final List<String> followQueryParams = new ArrayList<>();
        ...
        Builder(OkHttpClient okHttpClient) {
            ...
            this.followQueryParams.addAll(okHttpClient.followQueryParams);
        ...
        public List<String> followQueryParams() {
            return followQueryParams;
        }

        public Builder addFollowQueryParams(String paramName) {
            if (paramName == null) throw new IllegalArgumentException("followQueryParams == null");
            if (!followQueryParams.contains(paramName))
                followQueryParams.add(paramName);
            return this;
        }

        public Builder addAllFollowQueryParams(List<String> paramNames) {
            if (paramNames == null || paramNames.isEmpty())
                throw new IllegalArgumentException("followQueryParams == null");
            paramNames.removeAll(followQueryParams);
            followQueryParams.addAll(paramNames);
            return this;
        }

        public Builder addAllFollowQueryParams(String... paramNames) {
            if (paramNames.length == 0) throw new IllegalArgumentException("followQueryParams == null");
            for (String paramName : paramNames) {
                addFollowQueryParams(paramName);
            }
            return this;
        }
