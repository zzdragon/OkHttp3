...
public interface CookieJar {
    ...
    CookieJar NO_COOKIES = new CookieJar() {
        @Override
        public void saveFromResponse(HttpUrl url, RequestBody body, List<Cookie> cookies) {
        }

        @Override
        public List<Cookie> loadForRequest(HttpUrl url, RequestBody body) {
     ...
     * cookies.
     */
    void saveFromResponse(HttpUrl url, RequestBody body, List<Cookie> cookies);
     ...
     */
    List<Cookie> loadForRequest(HttpUrl url, RequestBody body);
}
